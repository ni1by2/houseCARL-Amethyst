...
/// file straight off disk, INCLUDING a plugin disabled in the Amethyst profile. Proves the load-bearing behaviours:
...
///      houseCARL just wrote before the Amethyst refresh registers it (HCBR-2026-07-14-02 gap 3: the write lane resolved
...
///
/// Self-contained: one manager-neutral fixture with real plugin bytes. The tool opens its OWN overlay and NEVER
...
internal static class ReadPluginFileProbe
{
    public static int RunGuard(string[] args)
    {
        ...
        try
        {
            ...
            // 1b — locate + read a plugin in an UNLISTED mod folder (a fresh houseCARL patch before the Amethyst refresh).
